...
BEGIN
  ...
  VALUES
    ...
    (p_kitchen_id, 'Full Hotel Pan', 'Full Hotel Pan', 'pan', 0),
    (p_kitchen_id, 'Half Hotel Pan', 'Half Hotel Pan', 'pan', 0),
    (p_kitchen_id, 'Third Pan', 'Third Pan', 'pan', 0),
    (p_kitchen_id, 'Shallow Sixth Pan', 'Shallow Sixth Pan', 'pan', 0),
    (p_kitchen_id, 'Sixth Pan', 'Sixth Pan', 'pan', 0),
    (p_kitchen_id, 'Shallow Ninth Pan', 'Shallow Ninth Pan', 'pan', 0),
    (p_kitchen_id, 'Ninth Pan', 'Ninth Pan', 'pan', 0),
    (p_kitchen_id, 'Full Sheet Pan', 'Full Sheet Pan', 'pan', 0),
    (p_kitchen_id, 'Half Sheet Pan', 'Half Sheet Pan', 'pan', 0),
    (p_kitchen_id, 'Quarter Sheet Pan', 'Quarter Sheet Pan', 'pan', 0),
    (p_kitchen_id, 'Perforated Pan', 'Perforated Pan', 'pan', 0),
...
CROSS JOIN (
  VALUES
    -- Pans (hotel/steam table sizes)
    ('Full Hotel Pan', 'Full Hotel Pan', 'pan'),
    ('Half Hotel Pan', 'Half Hotel Pan', 'pan'),
    ('Third Pan', 'Third Pan', 'pan'),
    ('Shallow Sixth Pan', 'Shallow Sixth Pan', 'pan'),
    ('Sixth Pan', 'Sixth Pan', 'pan'),
    ('Shallow Ninth Pan', 'Shallow Ninth Pan', 'pan'),
    ('Ninth Pan', 'Ninth Pan', 'pan'),
    ('Full Sheet Pan', 'Full Sheet Pan', 'pan'),
    ('Half Sheet Pan', 'Half Sheet Pan', 'pan'),
    ('Quarter Sheet Pan', 'Quarter Sheet Pan', 'pan'),
    ('Perforated Pan', 'Perforated Pan', 'pan'),
