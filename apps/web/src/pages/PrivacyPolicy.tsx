      ...
      >
        <section>
          ...
          <div className="space-y-4">
            <div>
              <h3 className="font-semibold mb-2 cursor-default">
                Account information:
              </h3>
              <p>
                When you sign up, we collect your email address and password
                (stored securely hashed, never in plain text).
              </p>
            </div>
            <div>
              <h3 className="font-semibold mb-2 cursor-default">
                Kitchen and prep data:
              </h3>
              <p>
                Everything you create in the app—kitchens, stations, prep lists,
                tasks, team assignments. This is your data.
              </p>
            </div>
            <div>
              <h3 className="font-semibold mb-2 cursor-default">Usage data:</h3>
              <p>
                Basic analytics like when you log in and what features you use.
            ...
            <div>
              ...
              <p>
                Team members who join a kitchen with a code don't need accounts.
                We don't collect personal information from them beyond a display
                name they choose.
              </p>
            </div>
          </div>
        ...
        <section>
          ...
          <p>
            Your data is stored securely on servers provided by Supabase (hosted
            on AWS). Data is encrypted in transit and at rest.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            We keep your data as long as your account is active. If you delete
            your account, we delete your data within 30 days.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            We use essential cookies to keep you logged in. We don't use
        ...
        <section>
          ...
          <p>
            If we make significant changes to this policy, we'll notify you via
            email or in the app.
          </p>
        </section>
