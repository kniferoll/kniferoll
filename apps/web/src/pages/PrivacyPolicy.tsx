          ...
          >
            <section>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p>
                    Everything you create in the app—kitchens, stations, prep
                    lists, tasks, team assignments. This is your data.
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold mb-2 cursor-default">
                  ...
                  <p>
                    Basic analytics like when you log in and what features you
                    use. This helps us improve the product.
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold mb-2 cursor-default">
                  ...
                  <p>
                    Team members who join a kitchen with a code don't need
                    accounts. We don't collect personal information from them
                    beyond a display name they choose.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2">
                ...
                <li>
                  To communicate with you about your account or important
                  updates
                </li>
              </ul>
              <p className="mt-4">
            ...
            <section>
              ...
              <p>
                ...
                (hosted on AWS). Data is encrypted in transit and at rest.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                delete your account, we delete your data within 30 days.
              </p>
            </section>
