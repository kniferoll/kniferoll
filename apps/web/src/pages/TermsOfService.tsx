            ...
            <div className="max-w-3xl mx-auto px-6 md:px-10 py-16">
              ...
              >
                <section>
                  ...
                  <p>
                    Kniferoll is a prep list management tool for kitchens. We
                    provide the software; you provide the content (your
                    kitchens, prep lists, etc.).
                  </p>
                </section>
                ...
                <section>
                  ...
                  <ul className="list-disc list-inside space-y-2">
                    ...
                    <li>
                      You're responsible for activity that happens under your
                      account
                    </li>
                    <li>
                ...
                <section>
                  ...
                  <p>
                    You own the content you create (kitchens, prep lists, tasks,
                    etc.). By using the service, you give us permission to store
                    and display that content to you and your team members—that's
                    how the app works.
                  </p>
                  <p className="mt-4">
                    We don't claim ownership of your content. We won't use it
                    for anything other than providing the service.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <ul className="list-disc list-inside space-y-2">
                    ...
                    <li>
                      You can cancel anytime; access continues until the end of
                      your billing period
                    </li>
                    <li>
                      Refunds are handled on a case-by-case basis—contact us if
                      you have an issue
                    </li>
                  </ul>
                </section>
                ...
                <section>
                  ...
                  <p>
                    We do our best to keep Kniferoll running smoothly, but we
                    can't guarantee 100% uptime. We may need to perform
                ...
                <section>
                  ...
                  <p>
                    We may add, change, or remove features over time. If we make
                    changes that significantly affect your use of the service,
                    we'll give you reasonable notice.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p>
                    Kniferoll is provided "as is." We're not liable for any
                    damages arising from your use of the service, including lost
                    data, lost revenue, or any other losses. Use good judgment
                ...
                <section>
                  ...
                  <p>
                    ...
                    we'll notify you via email or in the app. Continued use
